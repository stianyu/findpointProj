 ...
 * Return Type  : void
 */
void findpoint_api(const mxArray * const prhs[1], int32_T nlhs, const mxArray
                   *plhs[1])
{
  emxArray_real_T *P;
  real_T (*data)[2000];
 ...
 * Return Type  : void
 */
void findpoint_initialize(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
...
/*
 * File trailer for _coder_findpoint_api.c
 *
 * [EOF]
 */
